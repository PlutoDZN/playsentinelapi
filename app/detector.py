...
class Detector:
    ...
    def __init__(
        ...
        self.phrase_rules: List[PhraseRule] = [
            ...
            PhraseRule("platform_switch_action", "plattformwechsel", 25, re.compile(r"\b(wechsel|komm|schreib|add|invite|dm|pn|meld|join)\b.*\b(discord|snapchat|telegram|whatsapp|instagram|signal|skype|steam|riot|epic|battle\.net|kick|kik)\b", re.I)),
            PhraseRule("platform_switch_action_en", "plattformwechsel_en", 25, re.compile(r"\b(switch|move|message|dm|add|join|invite|text)\b.*\b(discord|snapchat|telegram|whatsapp|instagram|signal|skype|steam|riot|epic|battle\.net|kick|kik)\b", re.I)),
            PhraseRule("platform_mention_detected", "plattformwechsel_en", 15, re.compile(r"\b(discord|snapchat|telegram|whatsapp|instagram|signal|skype|steam|riot|epic|battle\.net|kick|kik)\b", re.I)),
